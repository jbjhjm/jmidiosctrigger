...
DemoComponent::DemoComponent ()
{
    ...
    DemoField->setText(TRANS("\n"
        ...
        "\n"
        "\t<mappings>\n"
        "\t\t<mapping channel=\"1\" type=\"all\" key=\"036\" trigger=\"ctrl1\" />\n"
        "\t\t<mapping channel=\"1\" type=\"noteon\" key=\"037\" trigger=\"ctrl2\" />\n"
        "\t\t<mapping channel=\"1\" type=\"noteon\" key=\"038\" trigger=\"preset1\" />\n"
        "\t\t<mapping channel=\"1\" type=\"noteon\" key=\"039\" trigger=\"multievent\" />\n"
        "\t\t<mapping channel=\"1\" type=\"noteon\" key=\"040\" ><midi type=\"pc\" channel=\"$axeChannel\" key=\"050\" value=\"127\" /></mapping>\n"
        "\t\t<mapping channel=\"1\" type=\"noteoff\" key=\"041\" ><midi type=\"pc\" channel=\"$axeChannel\" key=\"@key\" value=\"50\" /></mapping>\n"
        "\t\t<mapping channel=\"1\" type=\"noteoff\" key=\"042\" ><midi type=\"cc\" channel=\"3\" key=\"018\" value=\"@value\" /></mapping>\n"
        "\t</mappings>\n"
        "  \n"
        "</jmididata>"));
    //[/UserPreSize]
